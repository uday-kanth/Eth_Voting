...
return (
	...
	{/* <div className='row  p-5 d-flex justify-content-center text-center'><NavLink to='/Candidate' style={{cursor:"pointer"}}><button type='button' className='btn btn-lg btn-outline-dark fw-bold border-4 border border-dark' style={{ width:"250px", wordWrap:"break-word"}}>Candidate Register/Login</button> </NavLink></div> */}
